    ...
    def setup_ui(self):
        ...
        basic_box.setStyleSheet("""
            QGroupBox {
                ...
                border-radius: 8px; margin-top: 20px; padding-top: 18px;
            }
            QGroupBox::title {
                subcontrol-origin: margin; left: 16px;
                padding: 0 8px; background-color: transparent;
            }
            QCheckBox { color: #d0d0d0; font-size: 13px; spacing: 12px; }
            QCheckBox::indicator {
            ...
            QComboBox {
                ...
                color: #e0e0e0; min-width: 150px; font-size: 13px;
            }
            QComboBox:hover { border-color: #0d7377; }
        ...
        bundle_box.setStyleSheet("""
            ...
            QLineEdit:focus { border-color: #0d7377; }
            QPushButton {
                background-color: transparent; color: #0d7377;
                border: 1px solid rgba(13, 115, 119, 0.4);
                border-radius: 6px; padding: 10px 20px; font-weight: 500;
        ...
        from_path = self.app.settings.get('bundle_autosave_path') or os.path.join(
            os.path.expanduser('~'), '.config', 'aurora', 'bundles', 'default.json')
        try:
