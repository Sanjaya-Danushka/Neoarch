"""LargeSearchBox Component - Hero search UI with system health display"""
...
from PyQt6.QtCore import pyqtSignal, Qt, QTimer, QRectF, QSize, QPropertyAnimation, QEasingCurve
from PyQt6.QtGui import QColor, QFont, QIcon, QPixmap, QPainter, QResizeEvent
from PyQt6.QtSvg import QSvgRenderer

from typing import Any

from neoarch.resources.paths import APP_NAME, APP_VERSION, PROJECT_ROOT
...
class LargeSearchBox(QWidget):
    ...
    def set_search_icon(self):
        ...
        try:
            icon_path = os.path.join(PROJECT_ROOT, "assets", "icons", "discover", "search.svg")
